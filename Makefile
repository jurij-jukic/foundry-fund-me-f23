...
# tells make that these words are not folder names
# usuallt any command in the makefile should be put into .PHONY
...
# Clean the repo
clean  :; forge clean
# use ; if i want to define it in the same line
...
# to deploy to anvil use like so: make deploy
# to deploy to sepolia use like so: make deploy ARGS="--network sepolia"
